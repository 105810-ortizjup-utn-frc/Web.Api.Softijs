...
.UseSqlServer("Persist Security Info=False;Data Source=2022-softijs-sql-server-uat.database.windows.net;User ID=softijs-web-api;Password=MeGustaElIceCream2022;Initial Catalog=2022-softijs-sql-db-uat"));
